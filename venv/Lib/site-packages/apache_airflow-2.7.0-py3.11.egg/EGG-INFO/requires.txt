...
cryptography>=2.0.0
dask!=2022.10.1,!=2023.5.0,>=2.9.0
databricks-sql-connector<3.0.0,>=2.0.0
datadog>=0.14.0
distributed!=2023.5.0,>=2.11.1
dnspython>=1.13.0
docker>=5.0.3
...
jsonpath-ng>=1.5.3
kubernetes<24,>=21.7.0
kubernetes-asyncio<25,>=18.20.1
kylinpy>=2.6
ldap3>=2.5.1
looker-sdk>=22.2.0
...
[atlas]
apache-airflow-providers-apache-atlas
